...
DATABASES = {
    "default": {
        ...
        'NAME': os.getenv('PostgreSQL_DB_1_NAME'),
        'USER': os.getenv('PostgreSQL_DB_1_USER'),
        'PASSWORD': os.getenv('PostgreSQL_DB_1_PASSWORD'),
        'HOST': os.getenv('PostgreSQL_DB_1_HOST'),
        'PORT': os.getenv('PostgreSQL_DB_1_PORT'),
    }
}
